...
UINT g_iTexIndex = 0;
UINT BufferSlotSize[RootParam::END];
BOOL g_bColliderRender = FALSE;
	...
	_In_ int       nCmdShow)
{
	...
	while (true)
	{
		...
		else
		{
			...
			{
				pInputMgr->UpdateKey();
				pMainGame->Update(pFrameMgr->UpdateTime());
				pMainGame->Render();
			}
		}
	}
...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
	...
	HWND hWnd = CreateWindow(szWindowClass, L"3DGameProgramming", WS_OVERLAPPEDWINDOW, 0, 0, nWidth, nHeight, NULL, NULL, hInstance, NULL);
